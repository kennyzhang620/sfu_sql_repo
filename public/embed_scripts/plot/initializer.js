        ...
        <div class="Filters_Pane">
            <div id="reg_sect" style="text-align:left; padding: 6px;">
                ...
                <div id="selector_entry" style="padding:8px;">
        			<button id="prev_btn" onclick="movePtr(-1)"><</button><index id="counter_id" class="counters" style="padding: 6px; font-size:12px;">0 - 1000</index><button id="prev_btn" onclick="movePtr(1)">></button>
                </div>
            </div>
        </div>
			`;
