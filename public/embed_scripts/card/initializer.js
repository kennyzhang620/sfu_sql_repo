            ...
            <section class="map_container">
                ...
                <div class="map" id="map">
                    <div class="Settings_Pane">
                        <input type="image" src="https://educdv.ca/sfu-research-db/icons/home-icon.png" style="right: 60px;" id="homebtn">
                        <input type="image" src="https://educdv.ca/sfu-research-db/icons/search-icon.png" style="right: 60px;" id="settingsbtn">
